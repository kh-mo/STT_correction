...
joong = {19: 'ㅏ', 20: 'ㅐ', 21: 'ㅑ', 22: 'ㅒ', 23: 'ㅓ', 24: 'ㅔ', 25: 'ㅕ', 26: 'ㅖ', 27: 'ㅗ', 28: 'ㅘ',
         29: 'ㅙ', 30: 'ㅚ', 31: 'ㅛ', 32: 'ㅜ', 33: 'ㅝ', 34: 'ㅞ', 35: 'ㅟ', 36: 'ㅠ', 37: 'ㅡ', 38: 'ㅢ', 39: 'ㅣ', 40: ''}
joong_list = list(joong.keys())

jong = {41: 'ㄱ', 42: 'ㄲ', 43: 'ㄳ', 44: 'ㄴ', 45: 'ㄵ', 46: 'ㄶ', 47: 'ㄷ', 48: 'ㄹ', 49: 'ㄺ',
        50: 'ㄻ', 51: 'ㄼ', 52: 'ㄽ', 53: 'ㄾ', 54: 'ㄿ', 55: 'ㅀ', 56: 'ㅁ', 57: 'ㅂ', 58: 'ㅄ', 59: 'ㅅ',
        60: 'ㅆ', 61: 'ㅇ', 62: 'ㅈ', 63: 'ㅊ', 64: 'ㅋ', 65: 'ㅌ', 66: 'ㅍ', 67: 'ㅎ', 68: ''}
jong_list = list(jong.keys())

special = {69: ' ', 70: "1", 71: "2", 72: "3", 73: "4", 74: "5", 75: "6", 76: "7", 77: "8", 78: "9", 79: "0",
           80: "A", 81: "B", 82: "C", 83: "D", 84: "E", 85: "F", 86: "G", 87: "H", 88: "I", 89: "J", 90: "K", 91: "L",
           92: "M", 93: "N", 94: "O", 95: "P", 96: "Q", 97: "R", 98: "S", 99: "T", 100: "U", 101: "V", 102: "W",
           103: "X", 104: "Y", 105: "Z", 106: "<sos>", 107: "<eos>", 108: "<pad>", 109: '.'}
...
def decompose_letter(letter):
    if (ord(letter)>=12593 and ord(letter)<=12622):
        cho_idx = list(cho.values()).index(letter)
        joong_idx = list(joong.values()).index("")
        jong_idx = list(jong.values()).index("")
        ...
        if char in jamo_index:
            if char in list(cho.keys()):
                ...
                if tmp_JUNG == "null":
                    ...
                    result += joong[tmp_JUNG]
                    tmp_JUNG = char
            elif char in list(jong.keys()):
                if tmp_JONG == "null":
                    tmp_JONG = char
                else:
                    result += jong[tmp_JONG]
                    tmp_JONG = char
        else:
            result += special[char]
